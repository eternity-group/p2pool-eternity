...
nets = dict(
    eternity=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX='http://chainz.cryptoid.info/ent/block.dws?',
        ADDRESS_EXPLORER_URL_PREFIX='http://chainz.cryptoid.info/ent/address.dws?',
        TX_EXPLORER_URL_PREFIX='http://chainz.cryptoid.info/ent/tx.dws?',
