...
from p2pool.eternity import data as eternity_data, getwork
...
class StratumRPCMiningProvider(object):
    ...
    def _send_work(self):
        ...
        self.other.svc_mining.rpc_set_difficulty(eternity_data.target_to_difficulty(x['share_target'])).addErrback(lambda err: None)
    ...
    def rpc_submit(self, worker_name, job_id, extranonce2, ntime, nonce):
        ...
        header = dict(
            ...
            merkle_root=eternity_data.check_merkle_link(eternity_data.hash256(new_packed_gentx), x['merkle_link']),
